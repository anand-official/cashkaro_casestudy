...
const labels = {case:['Assignment alignment','Problem selection','Purchase journey','Evidence and limits','Market context','Initial segment','Opportunity sizing','Company advantage','Brief directions','Recommendation','Customer experience','First release','Product responsibilities','Benefit integrity','Business model','Delivery feasibility','Outcome experiment','Activation and rollout','Investment criteria','Final assessment']};
for (const [filename,slug,title,kicker,description] of pages) {
 ...
 const hero=slug==='case'?`<section class="hero"><div class="hero-copy"><p class="eyebrow">Product strategy / 13 September 2026</p><h1>The decision is made.<br><em>Make the purchase<br>rewarding.</em></h1><p class="hero-lede">CashKaro Universal Shopping Skill. Let an assistant pass the purchase to CashKaro, without taking over the recommendation.</p><div class="hero-actions"><a href="prototype.html" class="button primary">Explore the prototype <span aria-hidden="true">↗</span></a><a href="#metric" class="text-link">Read the case ↓</a></div><p class="byline">Ujjawal Anand <span>Concept proposal for CashKaro APM assignment</span></p></div><aside class="hero-route"><p class="eyebrow">The proposed moment</p><div class="conversation-fragment"><span>You</span><p>“This is the one. I'll buy it.”</p></div><div class="skill-fragment"><div class="skill-heading cashkaro-identity"><img src="assets/cashkaro-logo.svg" alt="CashKaro" width="120" height="30"><small>Universal Shopping Skill</small></div><h2>Keep the choice.<br>Add an eligible benefit.</h2><p>Check the purchase → show the benefit → create an approved retailer route.</p><a href="prototype.html">Explore the purchase journey ↗</a></div><p class="note">Illustrative host placement. Platform and partner approval required.</p></aside></section><div class="north-star"><span>One outcome</span><strong>Tracked orders / existing user / quarter</strong><span>Fixed cohort</span></div><div class="decision-strip"><p><strong>Decision</strong> Preserve the purchase decision. Offer an eligible route.</p><p><strong>Trade-off</strong> Potential recall reduction; less control over distribution.</p><p><strong>Proof required</strong> Additional total tracked orders in the fixed cohort.</p></div><div class="part-labels"><a href="#metric"><span>01—10</span> Understand the problem</a><a href="#experience"><span>11—20</span> Define and validate the solution</a></div>`:`<section class="page-hero"><p class="eyebrow">${kicker}</p><h1>${title}</h1><p>${description}</p></section>`;
...
const manifest={version:'4.2.1',product:'CashKaro Universal Shopping Skill',evidence_date:'2026-09-13',problem_words:words('problem'),solution_words:words('solution'),transcript_status:'partial — raw exports required',routes:[...pages.map(x=>x[0]),'prototype.html']};
fs.writeFileSync('build-manifest.json',JSON.stringify(manifest,null,2)+'\n');
fs.rmSync('dist',{recursive:true,force:true});
fs.mkdirSync('dist',{recursive:true});
const publicFiles = [
 'assets/styles.css','assets/site.js','assets/ai.js','assets/prototype.css','assets/prototype.js','assets/router-model.js','assets/host-model.js','assets/cashkaro-logo.svg','assets/favicon.svg','assets/phones/aster.svg','assets/phones/orion.svg','assets/phones/luma.svg',
 ...
 'source-material/cashkaro_assignment.pdf','source-material/ORIGINAL_ASSIGNMENT_TRANSCRIPT.md','source-material/QWEN_BEHAVIORAL_ANALYSIS_TEXT.md','source-material/DEEPSEEK_PRINCIPAL_PM_REVIEW.md','source-material/EXTERNAL_PRODUCT_FEEDBACK.md',
