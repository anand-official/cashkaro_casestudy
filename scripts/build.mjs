...
const manifest={version:'4.4.0',product:'CashKaro Universal Shopping Skill',evidence_date:'2026-09-13',core_sections:15,pdf_pages:15,pdf:'output/pdf/CashKaro_Visual_Brief.pdf',problem_words:words('problem')+Math.ceil(words('bridge')/2),solution_words:words('solution')+Math.floor(words('bridge')/2),decision_bridge_words:words('bridge'),balance_method:'Seven problem sections, seven solution sections; decision bridge allocated equally',transcript_status:'partial — raw exports required',routes:[...pages.map(x=>x[0]),'prototype.html']};
