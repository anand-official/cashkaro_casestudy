...
const labels = {case:['The mandate','Problem selection','Purchase journey','Evidence quality','Why now','Why CashKaro','Segment and reach','Direction selection','Customer experience','Product ownership','Scope and trust','Commercial assessment','Causal experiment','Validation and rollout','Decision criteria']};
...
const manifest={version:'4.3.0',product:'CashKaro Universal Shopping Skill',evidence_date:'2026-09-13',core_sections:15,problem_words:words('problem')+Math.ceil(words('bridge')/2),solution_words:words('solution')+Math.floor(words('bridge')/2),decision_bridge_words:words('bridge'),balance_method:'Seven problem sections, seven solution sections; decision bridge allocated equally',transcript_status:'partial — raw exports required',routes:[...pages.map(x=>x[0]),'prototype.html']};
fs.writeFileSync('build-manifest.json',JSON.stringify(manifest,null,2)+'\n');
fs.rmSync('dist',{recursive:true,force:true});
fs.mkdirSync('dist',{recursive:true});
const publicFiles = [
 'assets/styles.css','assets/brief.css','assets/walkthrough.js','assets/site.js','assets/ai.js','assets/prototype.css','assets/prototype.js','assets/router-model.js','assets/host-model.js','assets/cashkaro-logo.svg','assets/favicon.svg','assets/phones/aster.svg','assets/phones/orion.svg','assets/phones/luma.svg',
