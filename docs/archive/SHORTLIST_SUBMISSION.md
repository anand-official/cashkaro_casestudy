# Superseded Shortlist proposal

Archived from commit f482fb6 after independent review. This is a historical proposal, not the current recommendation. Current: [final submission](../FINAL_SUBMISSION.md).
