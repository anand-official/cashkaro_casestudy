...
## Bypass has several causes. Access is the selected hypothesis.
...
<p class="takeaway">Focus on purchases where a meaningful benefit exists but inserting CashKaro adds effort. This is a hypothesis about lost orders, not a measured diagnosis of the entire user base.</p>
</section>

<section class="case-section" id="journey" data-part="problem">
<p class="section-label">03 / Purchase journey</p>

## The opportunity sits between decision and checkout.
...
## There is evidence of friction. Its prevalence remains unknown.
...
<p class="takeaway">Next: reconstruct users' last three purchases, including routine and non-AI journeys. Identify actual lost routes before asking whether they like the feature.</p>
...
## Assistants are becoming purchase-decision surfaces.
...
OpenAI's product-discovery work and Google's Universal Cart support investigating this shift. They do not establish Indian transaction share or reach within CashKaro. Google's announced initial rollout is US-focused.
...
## External purchase routing already has a company precedent.
...
## Start with reachable users, then test the size of the opportunity.
...
Estimate this segment through a sampled survey linked, with consent, to pre-period order data. The phone is an interaction example; category selection must consider repeat frequency, eligible coverage and benefit size together.
...
## Retain the brief's problem. Extend its routing directions.
...
<ck-walkthrough aria-label="CashKaro guided purchase journey"></ck-walkthrough>
...
<p class="slide-source">Fictional product and offer; no instant discount, live integration or transaction. Actual retailer eligibility may differ substantially.</p>
...
## A reliable handoff is the first release.
...
## More CashKaro orders do not prove more retailer sales.
...
Early value may partly be attribution recapture with a visible user benefit. Consent does not override partner rules or justify silently replacing another referral.
...
## Fund learning before broad distribution.
...
## Proceed conditionally. Change direction when evidence requires it.
...
<p class="takeaway">The recommendation is a bounded validation investment. I would favour Share if it delivers comparable value with lower effort and better control.</p>
